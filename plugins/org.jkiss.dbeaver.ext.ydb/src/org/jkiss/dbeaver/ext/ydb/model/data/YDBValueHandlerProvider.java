...
/**
 * YDBValueHandlerProvider
 */
public class YDBValueHandlerProvider extends JDBCStandardValueHandlerProvider {

    @Override
    public DBDValueHandler getValueHandler(DBPDataSource dataSource, DBDFormatSettings preferences, DBSTypedObject typedObject) {
        String typeName = typedObject.getTypeName().toUpperCase();
        if (typeName.equals("JSON") || typeName.equals("JSONDOCUMENT")) {
