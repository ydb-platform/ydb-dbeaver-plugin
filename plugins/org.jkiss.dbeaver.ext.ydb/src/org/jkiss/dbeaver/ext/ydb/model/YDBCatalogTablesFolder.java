...
/**
 * YDB Tables container folder for catalog.
 * This is a folder that contains all table folders and root tables within a catalog.
 */
public class YDBCatalogTablesFolder implements DBSFolder {

    private final YDBCatalog catalog;
    ...
    public YDBCatalogTablesFolder(@NotNull YDBCatalog catalog) {
    ...
    private synchronized void buildHierarchy(@NotNull DBRProgressMonitor monitor) throws DBException {
        ...
        List<? extends GenericTableBase> allTables = catalog.getAllTables(monitor);
        if (allTables == null) {
            hierarchyBuilt = true;
            return;
        }
