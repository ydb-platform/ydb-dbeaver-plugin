 ...
 */
public class YDBExternalDataSourceFolder implements DBSFolder, YDBPermissionHolder {

    private static final Log log = Log.getLog(YDBExternalDataSourceFolder.class);
    ...
    @Association @NotNull
    public Collection<YDBExternalDataSourceFolder> getSubFolders() { return subFolders.values(); }
    ...
    public void addEntry(@NotNull YDBExternalDataSource entry) { entries.add(entry); }
